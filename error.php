<?php
const EMAIL_RECIPIENT = 'lostbelt@protonmail.com';
...
<div id="outline">
    ...
    echo change_url_parameter((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") .
    ...
    <?php
    $mailto="mailto:".EMAIL_RECIPIENT."?subject=%5BERR-REPORT%5D%20We%20need%20your%20attention%20on%20this%20error&".
