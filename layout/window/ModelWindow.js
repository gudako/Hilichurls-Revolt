...
class ModelWindow{
     ...
     * @param title {undefined|string|Object} If this is undefined, the window has no title;
     ...
     * @param context {string} A link to a PHP or HTML file that is loaded to be the context of the window.
     * Relative to the "/layout/window" folder.
     */
     ...
     * @param done {function} What's going to happen after the sort is done?
    ...
    open(done) {
        ...
        function finish(self) {
            $.get("/layout/window/" + self.#context).done((content) => {
     ...
     * @param iconlink {null|string} A link to the icon of the title bar. Can be null.
     * @param hasclosebtn {boolean} Whether the window itself has a close button.
     * @param color {string} The text color of the title.
     * @param backcolor {string} The background color of the title bar.
