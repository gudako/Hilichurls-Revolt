...
<div class="clip">
    ...
    <div id="bar1">
        ...
        <div id="bar1_advocate"><div><?php echo memtxt(2596,154/*REMAP%mainpage_bar1_text*/);?></div></div>
    </div>
    <div id="bar2">
        <?php echo memtxt(2750,124/*REMAP%mainpage_bar2_text*/);?>
    </div>
    <div id="bar3">
        ...
        <div id="bar3_statement"><?php echo memtxt(2874,162/*REMAP%mainpage_bar3_text1*/);?></div>
        <div id="bar3_advocate"><?php echo memtxt(3036,212/*REMAP%mainpage_bar3_text2*/);?></div>
    </div>
    <div id="bar4">
        <div>
            <?php echo memtxt(3248,833/*REMAP%mainpage_bar4_text*/);?>
        </div>
    </div>
    <div id="bar5">
        <div id="bar5_text1_div">
            <?php echo memtxt(4081,110/*REMAP%mainpage_bar5_text1*/);?>
            <sup><sup>(1)</sup></sup>
        </div>
        <div id="bar5_text2_div">
            <?php echo memtxt(4191,139/*REMAP%mainpage_bar5_text2*/);?>
        </div>
        <div id="bar5_img_div" class="clip_img">
            <img class="clip_img_movable" src="img/pages/mainpage/mainpage4.jpg">
        </div>
        <div id="bar5_text3_div">
            <?php echo memtxt(4330,319/*REMAP%mainpage_bar5_text3*/);?>
        </div>
    </div>
    <div id="bar6">
        <img src="img/pages/mainpage/mainpage_hilichurl_left.png"
             alt="<?php echo memtxt(4952,74/*REMAP%mainpage_slime_complaint!*/);?>">
        <div id="bar6_text">
            <img src="img/pages/icons/fight.png">
            <div>
                <?php echo memtxt(4649,303/*REMAP%mainpage_bar6_text*/);?>
            </div>
        </div>
    ...
    <div class="credit">
        <sup>(1)</sup> <?php echo memtxt(5143,74/*REMAP%mainpage_credit*/);?>
    </div>
</div>
</body>
